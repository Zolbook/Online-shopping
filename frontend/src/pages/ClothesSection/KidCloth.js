...
export default function KidCloth(){
    ...
    const{handleChange, handleClick, handleChangeCart, cartArray, handleClickCart, checkedArray, kidClothes}=useContext(DataContext);
    ...
    return(
<div className="kid">
        {kidClothes.map((product) => (
         <div className='products' key={product._id}>
          <Link to={`/kidsclothes/${product._id}`}>
