...
export default function MenCloth() {
  ...
  const { handleChange, handleClick, handleChangeCart, cartArray, handleClickCart, checkedArray, onAdd, onDelete, menclothes } = useContext(DataContext);
