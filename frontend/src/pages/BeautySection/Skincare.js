...
export default function Skincare() {
  ...
  const { handleChange, handleClick, handleChangeCart, cartArray, handleClickCart, checkedArray, onAdd, onDelete, skincare } = useContext(DataContext);
