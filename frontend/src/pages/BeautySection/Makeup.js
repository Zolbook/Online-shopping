...
export default function Makeup() {
  ...
  const { handleChange, handleClick, handleChangeCart, cartArray, handleClickCart, checkedArray, makeup, onAdd, onDelete } = useContext(DataContext);
